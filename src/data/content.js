...
export const QUESTIONS = [
  ...
  },
  {
    ...
    correct: 'b',
    explanation:
      'Крупные блоки «component» и соединения через предоставляемые/требуемые интерфейсы — диаграмма компонентов.',
  },
  {
    id: 'cp-if',
    topic: 'structure',
  ...
  },
  {
    ...
    correct: 'b',
    explanation:
      'Трёхмерные узлы (устройства или среды выполнения) и артефакты внутри них — deployment diagram.',
  },
  {
    id: 'dp-node',
    topic: 'structure',
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'Все листья дерева узлов сразу' },
    ...
    correct: 'b',
    explanation:
      'A-0 — рамка модели: назначение, точка зрения и единственный блок A0. Его декомпозиция — диаграмма A0 (1-й уровень).',
  },
  {
    id: 'i0-count',
    topic: 'idef0',
  ...
  },
  {
    ...
    prompt: 'Какая это диаграмма?',
    options: [
      { id: 'a', text: 'Диаграмма классов с наследованием' },
      { id: 'b', text: 'Дерево узлов IDEF0' },
      { id: 'c', text: 'Диаграмма прецедентов' },
      { id: 'd', text: 'DFD 0-го уровня' },
    ],
    correct: 'b',
    explanation:
      'Node tree — оглавление модели: иерархия номеров A0, A1, A11… без стрелок ICOM.',
  },
  {
    id: 'i0-num',
    topic: 'idef0',
    ...
    options: [
      ...
      { id: 'c', text: '2.1, 2.2 как в DFD' },
      { id: 'd', text: 'Оставляют номер A2 у всех' },
    ],
    correct: 'b',
    explanation:
      'Номер ребёнка = номер родителя + цифра. A1 → A11, A12; A2 → A21, A22. Точки 1.1 — это стиль DFD, не IDEF0.',
  },
  {
    id: 'i0-lv',
    topic: 'idef0',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: 'Чтобы модель не смешивала разные аудитории и задачи в одном дереве' },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: 'IDEF0 A-0' },
      { id: 'b', text: 'Контекстная DFD (уровень 0)' },
      { id: 'c', text: 'Диаграмма прецедентов' },
      { id: 'd', text: 'Диаграмма компонентов' },
    ],
    correct: 'b',
    explanation:
      'Один процесс-система, внешние сущности и именованные потоки. Хранилищ на контексте обычно нет — это DFD уровня 0.',
  },
  {
    id: 'df-el',
    topic: 'dfd',
  ...
  },
  {
    id: 'df-num',
    topic: 'dfd',
    prompt: 'Как нумеруют процессы при создании DFD 1-го уровня?',
    options: [
      { id: 'a', text: 'A1, A2, A3' },
      { id: 'b', text: '1.0, 2.0, 3.0 (или 1, 2, 3) — дети единственного контекстного процесса' },
      { id: 'c', text: 'Римскими цифрами узлов развёртывания' },
      { id: 'd', text: 'Номера не ставят' },
    ],
    correct: 'b',
    explanation:
      'Контекст — процесс 0. Первый уровень: 1.0, 2.0… Второй: 1.1, 1.2 внутри 1.0. Это не нумерация IDEF0.',
  },
  {
    id: 'df-bal',
    topic: 'dfd',
    prompt: 'Что такое балансировка DFD?',
    options: [
      { id: 'a', text: 'Одинаковое число блоков на каждом листе IDEF0' },
      { id: 'b', text: 'Потоки родителя совпадают с внешними потоками дочерней диаграммы' },
      { id: 'c', text: 'Равная длина линий жизни' },
      { id: 'd', text: 'Одинаковая кратность у всех классов' },
    ],
    correct: 'b',
    explanation:
      'Что вошло и вышло из процесса на уровне N, должно войти и выйти из его декомпозиции на уровне N+1. Внутренние потоки детей на родителе не показывают.',
  },
  {
    id: 'df-l1',
    topic: 'dfd',
    ...
    prompt: 'Какая это диаграмма?',
    options: [
      { id: 'a', text: 'IDEF0 1-го уровня' },
      { id: 'b', text: 'DFD 1-го уровня' },
      { id: 'c', text: 'Диаграмма последовательности' },
      { id: 'd', text: 'Диаграмма развёртывания' },
    ],
    correct: 'b',
    explanation:
      'Несколько пронумерованных процессов, хранилище D1 и внешняя сущность — разложение контекста, DFD уровня 1.',
  },
  {
    id: 'df-shape',
    topic: 'dfd',
    ...
    correct: 'a',
    explanation:
      'Yourdon–DeMarco: процесс — окружность. Gane–Sarson: скруглённый прямоугольник. Хранилище — две линии или «открытый» прямоугольник.',
  },
  {
    id: 'df-ctx',
    topic: 'dfd',
    ...
    correct: 'b',
    explanation:
      'Контекст — один процесс «система» и внешние сущности. Детализация начинается с уровня 1.',
  },
  {
    id: 'df-hot',
    topic: 'dfd',
    ...
    correct: 'store',
    explanation:
      'Хранилище — две горизонтали (или открытый прямоугольник) с именем набора данных. Круг — процесс, квадрат — внешняя сущность.',
  },
]
